                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Category')">
                                    {{ optional($product->category)->name ?? __('Category not set') }}
                                </td>
...
<div class="d-flex flex-wrap justify-content-sm-end header-search-wrapper">
    ...
    <a class="btn btn-sm btn--primary box--shadow1 text--small" href="{{ route('merchant.vehicle.create') }}"><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
</div>
@endpush
