                ...
                <div class="card card-deposit pt-3">
                    <div class="card-body mt-4">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" value="{{showAmount($withdraw->merchant->balance - ($withdraw->amount))}}"  class="form-control form-control-lg" placeholder="@lang('Enter Amount')" required readonly>
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="font-weight-bold pull-right">{{ showAmount(auth()->guard('merchant')->user()->balance)}} {{ __($general->cur_text) }}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-6">
                                <form action="{{route('merchant.withdraw.submit')}}" method="post" enctype="multipart/form-data">
                                    @csrf
