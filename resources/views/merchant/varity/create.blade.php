...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{route('merchant.veriety.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                                    ...
                                    <div class="row mb-none-15">
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " placeholder="@lang('Variety Name')" name="name" value="{{ old('name') }}" required/>
                                            </div>
                                        </div>
