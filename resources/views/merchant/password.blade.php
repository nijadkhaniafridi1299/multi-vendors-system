        ...
        <div class="col-xl-9 col-lg-8 col-md-7 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('merchant.change.password') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
@push('breadcrumb-plugins')
    <a href="{{route('merchant.profile')}}" class="btn btn-sm btn--primary box--shadow1 text--small" ><i class="fa fa-user"></i>@lang('Profile Setting')</a>
@endpush
