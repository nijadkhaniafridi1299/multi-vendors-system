    ...
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="{{asset('assets/admin/images/1.jpg')}}">
            <div class="form-wrapper">
                ...
                <form method="POST" action="{{ route('merchant.verify.email') }}"
                    onsubmit="return submitUserForm();" class="cmn-form mt-30 account-form">
                    @csrf
                    <div class="form-group">
                        <p class="text-center">@lang('Your Email'): <strong>{{ auth()->guard('merchant')->user()->email }}</strong></p>
                    </div>
                    ...
                    <div class="form-group">
                        <p>@lang('Please check including your Junk/Spam Folder. if not found, you can') <a
                                href="{{ route('merchant.send.verify.code') }}?type=email"
