...
<script>
  ...
  // Function to show a simple popup message
  function showMessage() {
    alert("This is a simple message popup!");
}

// Attach the showMessage function to the button click event
document.getElementById("showPopupButton").addEventListener("click", showMessage);
