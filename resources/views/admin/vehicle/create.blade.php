                                ...
                                <div class="content">
                                    <div class="row mb-none-15">
                                        ...
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                            <div class="input-group has_append">
                                                <div class="form-group">
                                                  <label class="w-100 font-weight-bold"><span class="text-danger"></span></label>
                                        ...
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                                ...
                                                <input type="text" class="form-control"  id="locationInput" placeholder="@lang('Current Latitude')" name="latitude" value="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                                ...
                                                <input type="text" class="form-control"  id="locationInputs" placeholder="@lang('Current Longitude')" name="longitude" value="" />
