                    ...
                    <table class="table table--light style--two">
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Action')">
                                <a href="{{ route('admin.productitem.edit', $product->id) }}" class="icon-btn mr-1" data-toggle="tooltip" data-original-title="@lang('Edit')">
...
<div class="d-flex flex-wrap justify-content-sm-end header-search-wrapper">
    ...
    <a class="btn btn--primary box--shadow1 text--small" href="{{ route('admin.productcat.create') }}"><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
</div>
