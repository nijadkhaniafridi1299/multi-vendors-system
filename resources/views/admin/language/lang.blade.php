            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('admin.language.manage.store')}}">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn--primary btn-block" id="btn-save" value="add">@lang('Save')</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn--primary btn-block" id="btn-save" value="add">@lang('Update')</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="">
                    ...
                    <div class="modal-body">
                        <p class="text-muted">@lang('Are you sure to delete this language?')</p>
                    </div>
                    <div class="modal-footer">
