                                            ...
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    ...
                                                    <div class="profilePicPreview"
                                                        style="background-image: url('{{ getImage(imagePath()['currency']['path'] . '/' . $currency->image, imagePath()['currency']['size']) }}')">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="">@lang("Name") <strong
                                                    class="text-danger">*</strong></label>
                                            <input type="text" value="{{ @$currency->name }}" class="form-control"
                                                name="name" title="name" placeholder="@lang('Enter Currency Name')">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="">@lang("Symbol") <strong
                                                    class="text-danger">*</strong></label>
                                            <input type="text" value="{{ @$currency->symbol }}" class="form-control"
                                                name="symbol" title="symbol" placeholder="@lang('Symbol')">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="">@lang('Price') <strong
                                                    class="text-danger">*</strong></label>
                                            <input type="text" value="{{ @$currency->price }}" class="form-control"
                                                name="price" placeholder="@lang('Parcent Change 24 Hours')">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="">@lang('Price Change Percent 24 Hours') <strong
                                                    class="text-danger">*</strong></label>
                                            <input type="text" value="{{ @$currency->percent_change_24h }}"
                                                class="form-control" name="percent_change_24h"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="percent_change_7d"
                                                placeholder="@lang('Pricing Chaning Percent In Last 7days')"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="market_cap"
                                                value="{{ @$currency->market_cap }}" placeholder="@lang('Market Cap')">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="volume_24h"
                                                placeholder="@lang('Volume 24 Hours')" value="{{ @$currency->volume_24h }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <button class="btn btn--primary btn-block">@lang("Update")</button>
                                    </div>
                                </div>
