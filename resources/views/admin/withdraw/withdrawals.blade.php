                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('User')">
                                    <span class="font-weight-bold">{{ $withdraw->merchant->fullname }}</span>
                                    <br>
                                    <span class="small"> <a href="{{ route('admin.merchants.detail', $withdraw->merchant_id) }}"><span>@</span>{{ $withdraw->merchant->username }}</a> </span>
                                </td>
