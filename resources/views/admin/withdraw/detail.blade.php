                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="font-weight-bold">
                                <a href="{{ route('admin.merchants.detail', $withdrawal->merchant_id) }}">{{ @$withdrawal->merchant->username }}</a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.withdraw.approve') }}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn--primary btn-block">@lang('Approve')</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.withdraw.reject')}}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn--danger btn-block">@lang('Reject')</button>
                    </div>
                </form>
            </div>
        </div>
